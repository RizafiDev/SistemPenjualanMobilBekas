...
class CreateStokMobilRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'no_rangka' => 'required|string|max:255|unique:stok_mobils,no_rangka',
			'no_mesin' => 'required|string|max:255|unique:stok_mobils,no_mesin',
			'no_polisi' => 'nullable|string|max:15|unique:stok_mobils,no_polisi',
